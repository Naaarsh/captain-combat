...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post fighters_url, params: { fighter: { attack: @fighter.attack, bio: @fighter.bio, critical: @fighter.critical, dodge: @fighter.dodge, life: @fighter.life, name: @fighter.name } }
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { attack: @fighter.attack, bio: @fighter.bio, critical: @fighter.critical, dodge: @fighter.dodge, life: @fighter.life, name: @fighter.name } }
