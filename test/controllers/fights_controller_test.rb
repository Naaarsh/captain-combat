...
class FightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fight" do
    assert_difference('Fight.count') do
      post fights_url, params: { fight: { looser_id: @fight.looser_id, text: @fight.text, winner_id: @fight.winner_id } }
    end
  ...
  test "should update fight" do
    patch fight_url(@fight), params: { fight: { looser_id: @fight.looser_id, text: @fight.text, winner_id: @fight.winner_id } }
